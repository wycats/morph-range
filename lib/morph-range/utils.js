...
export var CONTENT_STATES = [null, "comment", "blank", "contents", "fragment", "list", "empty list"];
...
export var UPDATING = 4;   // the morph is expecting an update
export var WAS_STABLE = 5; // the morph was stable after expecting an update
export var MOVING = 6;     // the morph is in the process of moving
export var DESTROYED = 7;  // the morph has been destroyed
export var STABILITY_STATES = [null, "detached", "appending", "attached", "updating", "stable", "moving", "destroyed"];
