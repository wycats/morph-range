...
function Morph(domHelper) {
  ...
  // commit is called. For more dynamic control of morphs, use
  // MorphList.
...
// This method is intended to be called to begin a transaction for rerendering. If commit is
...
Morph.prototype.commit = function Morph$commit() {
