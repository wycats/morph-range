...
import {
  ...
  DETACHED, APPENDING, ATTACHED, DESTROYED,
  STABILITY_STATES
...
Morph.prototype.initForAppendingToList = function(morphList) {
  ...
  this.contextualElement = morphList.parentMorph.contextualElement;
...
Morph.prototype.clearForRender = function() {
  ...
  switch (this.stability) {
    case APPENDING:
      ...
      return;
    case ATTACHED:
      if (this.contentState === COMMENT) { return; }
      this.willClear();
      this.beginAppending();
...
Morph.prototype.setContent = function Morph$setContent(content) {
  ...
  switch (typeof content) {
    case 'object':
      ...
      if (this.lastValue === content.string) { return; }
      this.lastValue = content.string;
      return this.setHTML(content.string);
    case 'string':
      if (this.lastValue === content) { return; }
